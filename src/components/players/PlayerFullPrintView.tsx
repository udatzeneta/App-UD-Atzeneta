          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {(() => {
              ...
              const points = sortedStats.map((s, idx) => {
                ...
                return { x, y, minutes: s.minutes_played || 0, label: `J.${s.matchday}`, rival: s.rival, goals: s.goals || 0, assists: s.assists || 0, yellows: s.yellow_cards || 0, reds: s.red_cards || 0 };
              });
